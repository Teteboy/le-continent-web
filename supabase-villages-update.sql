-- =====================================================
-- UPDATE VILLAGES TABLE WITH DETAILED ETHNIC GROUP DATA
-- Using existing columns: name, region
-- =====================================================

-- Step 1: Clear existing data and insert the detailed ethnic group data
-- Format: name = "MainName (Alternatives)", region = "Country, Region"
...
-- =====================================================
-- Display format in the app:
-- 
-- Name: "Ewondo (Beti, Boulou, Fang)"
-- Region: "Cameroun, Centre"
--
-- The frontend will display:
-- Ewondo (Beti, Boulou, Fang)
-- Cameroun, Centre
-- =====================================================