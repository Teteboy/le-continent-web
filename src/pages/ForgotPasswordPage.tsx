...
export default function ForgotPasswordPage() {
  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await resilientFetch(`${API_BASE}/api/auth/forgot-password`, {
        method: 'POST',
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await resilientFetch(`${API_BASE}/api/auth/verify-reset-code`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await resilientFetch(`${API_BASE}/api/auth/reset-password`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
          userId, 
