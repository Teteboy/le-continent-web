...
export default function HistoirePage() {
  ...
  const filtered = histoires.filter(item => item.title.toLowerCase().includes(search.toLowerCase()));
  ...
  const lockedCount = isPremium ? 0 : Math.max(0, histoires.length - FREE_LIMIT);
