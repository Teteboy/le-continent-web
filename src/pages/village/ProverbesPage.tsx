              ...
              {!isLoading && items.length > 0 && (
                <p className="text-gray-500 text-sm mt-0.5">
                  {isPremium
                    ...
                    : `${unlockedItems.length} proverbes gratuits`}
        ...
        {!isLoading && !error && (
          <div>
            ...
            <div className="space-y-4 mb-4">
              {unlockedItems.map((item: Proverbe) => (
            ...
            {!isPremium && lockedOnPage > 0 && (
              <LockedItemsList<Proverbe>
                items={Array(lockedOnPage).fill(null).map((_, i) => ({ id: `locked-${i}` } as Proverbe))}
                onUnlock={handleUpgrade}
    renderItem={() => <div className="p-5">
