              ...
              {!isLoading && total > 0 && (
                <p className="text-gray-500 text-sm mt-0.5">
                  {isPremium
                    ...
                    : `${unlockedItems.length} phrases gratuites`}
          ...
          <div>
            ...
            {!isPremium && lockedOnPage > 0 && (
              <LockedItemsList<Phrase>
                items={Array(lockedOnPage).fill(null).map((_, i) => ({ id: `locked-${i}` } as Phrase))}
                onUnlock={handleUpgrade}
                maxInitialDisplay={lockedOnPage}
                renderItem={() => <div className="p-5 border-l-4" style={{ borderLeftColor: '#16A085' }}>
