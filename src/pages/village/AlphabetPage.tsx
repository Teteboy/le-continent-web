        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4">
          ...
          {!isLoading && total > 0 && (
            <p className="text-gray-500 text-sm">
              {isPremium ? `${startItem}-${endItem} sur ${total} lettres` : `${unlockedItems.length} lettres gratuites`}
            ...
            <div>
              ...
              {!isPremium && lockedOnPage > 0 && (
                <LockedItemsList<AlphabetEntry>
                  items={Array(lockedOnPage).fill(null).map((_, i) => ({ id: `locked-${i}` } as AlphabetEntry))}
                  onUnlock={handleUpgrade}
                  renderItem={() => <div className="grid grid-cols-[1fr_1fr_auto] gap-4 items-center px-4 py-4">
