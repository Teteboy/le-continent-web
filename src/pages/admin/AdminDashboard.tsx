...
import {
  ...
  LogOut, Menu, X, Shield, ChevronRight, Table2, CreditCard, DollarSign,
} from 'lucide-react';
...
type AdminSection = 'overview' | 'users' | 'villages' | 'promo-codes' | 'referrals' | 'payments' | 'withdrawals' | 'data' | 'setup';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'withdrawals', label: 'Retraits',            icon: <DollarSign size={18} /> },
